...
export const Terminal: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-7xl xl:px-6 mx-auto my-24 ">
      {/* Decorative Header */}
      <div className="border rounded-md border-palantir-gray bg-palantir-dark/50 backdrop-blur relative overflow-hidden group">
